...
<?php endif; // ! is_page_template( 'page-template-blank.php' ) ?>
	...
	<div class="plainoverlay" style="position: fixed;left: 0px;top: 0px;cursor: wait;background-color: rgb(136, 136, 136);z-index: 9000;width: 100%;height: 100vh;opacity: 0.6;"></div>
	<div style="position: fixed;z-index: 9001;cursor: wait;width: 300px;height: 300px;left: 0;top: 0;right: 0;bottom: 0;margin: auto;"><div class="jQuery-plainOverlay-progress" style="border-top-width: 10px;"></div></div>
</body>
</html>
